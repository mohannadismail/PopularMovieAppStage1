...
public class MovieTaskAPI extends AsyncTask<String, Void, Movies[]> {

    private final CallbackInterface movieTaskCallback;

    MovieTaskAPI(CallbackInterface movieTaskCallback) {
